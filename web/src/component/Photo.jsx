...
//       <Link to={`/movies/${photo.id}`} className="font-semibold">
//         <img src={photo.photo} alt="Movie poster" />
//       </Link>
//       <button
//         type="button"
//         className="py-3 px-5 rounded-full
// bg-white absolute bottom-0 right-0 shadow-xl -mb-6 mr-4 text-lg
// hover:bg-gray-900 hover:text-white hover:border border text-gray-900 cursor-pointer"
//       >
//         Reserve
//       </button>
//     </div>
...
//         <li className="w-8 h-8 border border-gray-300 rounded-full
